...
extern __attribute__((__visibility__("default")))           _Bool                igIsWindowChildOf(ImGuiWindow* window,ImGuiWindow* potential_parent,                                                                                   _Bool                                                                                         popup_hierarchy);
...
extern __attribute__((__visibility__("default"))) ImGuiKeyOwnerData* igGetKeyOwnerData(ImGuiKey key);
...
extern __attribute__((__visibility__("default"))) void igDebugNodeDrawList(ImGuiWindow* window,const ImDrawList* draw_list,const char* label);

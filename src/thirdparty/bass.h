/* BASS 1.8a C/C++ header file, copyright (c) 1999-2003 Ian Luck.
...
#define BASS_DATA_FFT4096S	0x80000013	// stereo 4096 FFT
...
void BASSDEF(BASS_SetCLSID)(const GUID *clsid);
...
HMUSIC BASSDEF(BASS_MusicLoad)(BOOL mem, const void *file, DWORD offset, DWORD length, DWORD flags);
...
HSTREAM BASSDEF(BASS_StreamCreate)(DWORD freq, DWORD flags, const void *proc, DWORD user);
...
HSTREAM BASSDEF(BASS_StreamCreateURL)(const char *url, DWORD offset, DWORD flags, const char *save);
...
BOOL BASSDEF(BASS_CDInit)(const char *drive, DWORD flags);

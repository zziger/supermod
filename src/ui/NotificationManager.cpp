...
namespace ui
{
    ...
    void NotificationManager::Render()
    {
        ...
        {
            if (y - viewport->Pos.y < Ui::ScaledPx(100)) break;
            ...
            ImGui::SetNextWindowPos({ viewport->Pos.x + viewport->Size.x - Ui::ScaledPx(HORIZONTAL_PADDING), y }, ImGuiCond_Always, { 1, 1 });
                ...
                | ImGuiWindowFlags_NoDocking);
            {
                ...
                auto max = ImGui::GetWindowSize() * ImVec2(fill, 1) + ImGui::GetWindowPos() - ImVec2(borderSize, borderSize);
                ...
                if (ImGui::IsWindowHovered()) hovered = true;

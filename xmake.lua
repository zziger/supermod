...
add_requires("luajit-fork c4e5be9762a6fe9b8e7a270f4bc94c620712a02e")
add_requires("yaml-cpp 0.7.0")
add_requires("tga 2022.05.05")
add_requires("gtest v1.14.0")
add_requires("base-n 2020.05.28")
...
add_files("./src/**.def")
add_files("./src/**.rc")
set_pcxxheader("./src/supermod/pch.hpp")
